<%@ Page Language="C#" 
    ...
    Inherits="NestedMasterPagesTask.bg_BG.Contacts"
    MasterPageFile="~/bg-BG/BgMasterPage.master"
    Title="Контакти" %>

<asp:Content runat="server" ContentPlaceHolderID="BgContent">
...
Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; aliquam dui neque, varius eu laoreet vel.</p>
</asp:Content>