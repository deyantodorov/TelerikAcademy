<%@ Page Language="C#" 
    ...
    CodeBehind="RegistrationWithServerValidation.aspx.cs" 
    Inherits="ValidationControls.RegistrationWithServerValidation"
            ...
            <asp:Panel ID="PanelAddressInfo" runat="server">
                ...
                <asp:TextBox ID="tbEmail" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator
                        ...
                        ForeColor="Red"
                        EnableClientScript="false" ValidationGroup="AddressInfo" />
