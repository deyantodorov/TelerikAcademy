...
namespace T01.Northwind
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> ups_GetTotalIncome(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            var supplierNameParameter = supplierName != null ?
                new ObjectParameter("supplierName", supplierName) :
                new ObjectParameter("supplierName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("ups_GetTotalIncome", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}
