namespace T01.PriorityQueueImplementation
{
    ...
    /// <summary>
    /// Priority queue based on binary heap, elements with minimum priority dqueued first
    /// </summary>
    ...
    public class PriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
    {
        ...
        public static PriorityQueue<TPriority, TValue> MergeQueues(PriorityQueue<TPriority, TValue> pq1, PriorityQueue<TPriority, TValue> pq2)
        {
            ...
            if (!Equals(pq1.comparer, pq2.comparer))
            {
        ...
        private static void CheckIsNull(object obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException("obj", "Value can't be null");
            }
        }
